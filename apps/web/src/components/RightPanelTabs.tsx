...
const SURFACE_DISABLED_REASONS = {
  ...
  sidechat: "Sidechats are only available on started server threads.",
} as const;
...
function RightPanelEmptyState(props: {
  ...
  const actions = [
    ...
    {
      label: "Sidechat",
      description: "Spawn a side conversation.",
...
function SurfaceIcon({
  ...
  switch (surface.kind) {
    ...
    case "sidechat":
      return <MessageSquareText className="size-3.5 shrink-0" />;
  }
}
