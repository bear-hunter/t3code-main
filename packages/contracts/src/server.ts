...
export const ServerProvider = Schema.Struct({
  ...
  // Sessions on this provider can natively fork another session's state
  // (sidechats skip the transcript seed when this is set).
  supportsSessionFork: Schema.optional(Schema.Boolean),
  enabled: Schema.Boolean,
